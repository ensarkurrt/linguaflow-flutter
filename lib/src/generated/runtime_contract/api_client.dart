...
class ApiClient {
  ApiClient({
    this.basePath = 'https://api.linguaflow.dev',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'AppAttestAssertionRequestDto':
          return AppAttestAssertionRequestDto.fromJson(value);
        case 'AppAttestChallengeRequestDto':
          return AppAttestChallengeRequestDto.fromJson(value);
        case 'AppAttestChallengeResponseDto':
          return AppAttestChallengeResponseDto.fromJson(value);
        case 'AppAttestRegistrationRequestDto':
          return AppAttestRegistrationRequestDto.fromJson(value);
        case 'DeliveryManifestResponseDto':
        ...
        case 'MissingKeyReportRequestDto':
          return MissingKeyReportRequestDto.fromJson(value);
        case 'MissingKeyReportResponseDto':
          return MissingKeyReportResponseDto.fromJson(value);
        case 'MissingKeyTelemetryPolicyResponseDto':
          return MissingKeyTelemetryPolicyResponseDto.fromJson(value);
        case 'PlayIntegrityChallengeRequestDto':
          return PlayIntegrityChallengeRequestDto.fromJson(value);
        case 'PlayIntegrityChallengeResponseDto':
